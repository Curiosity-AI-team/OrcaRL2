...
#ifndef ORCA_FREE_FLEET_SERVER__SRC__SERVERNODECONFIG_HPP
#define ORCA_FREE_FLEET_SERVER__SRC__SERVERNODECONFIG_HPP
...
#endif // ORCA_FREE_FLEET_SERVER__SRC__SERVERNODECONFIG_HPP
