...
#include "driver_odrive/diffbot_system.hpp"
...
hardware_interface::return_type driver_odrive::DiffBotSystemHardware::write()
{
...
PLUGINLIB_EXPORT_CLASS(
  driver_odrive::DiffBotSystemHardware, hardware_interface::SystemInterface)